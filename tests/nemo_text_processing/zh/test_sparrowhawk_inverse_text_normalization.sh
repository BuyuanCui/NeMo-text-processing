...
#testITNMeasure() {
#  input=$PROJECT_DIR/zh/data_inverse_text_normalization/test_cases_measure.txt
#  runtest $input
#}
...
#testITNElectronic() {
#  input=$PROJECT_DIR/zh/data_inverse_text_normalization/test_cases_electronic.txt
#  runtest $input
#}
