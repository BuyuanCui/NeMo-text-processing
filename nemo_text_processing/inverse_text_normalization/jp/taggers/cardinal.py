...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        graph_hundred_component += pynini.union(graph_teen | pynutil.insert("00"), (graph_ties | pynutil.insert("0")) + (graph_digit | pynutil.insert("0")))
        ...
        graph_hundredthousand_component = pynini.union((graph_teen | ((graph_ties | pynutil.insert("0")) + (graph_digit | pynutil.insert("0")))) + tenthousand, pynutil.insert("00"))
        ...
        graph_billion_component = pynini.union((graph_teen | ((graph_ties | pynutil.insert("0")) + (graph_digit | pynutil.insert("0")))) + hundredmillion, pynutil.insert("00"))
        ...
        graph_hundredbillion_component = pynini.union(graph_thousand_component + hundredmillion, pynutil.insert("0000"))
        graph_hundredbillion_component += graph_tenmillion_component

        graph_thousandbillion_component = pynini.union(graph_tenthousand_component + hundredmillion, pynutil.insert("00000"))
        ...
        graph_tentrillion_component = pynini.union((graph_teen | ((graph_ties | pynutil.insert("0")) + (graph_digit | pynutil.insert("0")))) + trillion, pynutil.insert("00"))
        ...
        optional_sign = (pynutil.insert("positive: \"") + (pynini.accep("+") | pynini.accep("プラス")) + pynutil.insert("\"")) | (pynutil.insert("negative: \"") + (pynini.accep("-") | pynini.accep("マイナス")) + pynutil.insert("\""))
        final_graph = (optional_sign + pynutil.insert(" ") + pynutil.insert("integer: \"") + graph + pynutil.insert("\"")) | (pynutil.insert("integer: \"") + graph + pynutil.insert("\""))
